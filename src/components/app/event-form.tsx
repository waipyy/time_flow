...
import { CalendarIcon, Loader2, Check, Trash2 } from 'lucide-react';
...
export function EventForm({ isOpen, onOpenChange, eventToEdit, onFinished, onCancelled, availableTags, className }: EventFormProps) {
    ...
    } catch (error)
{
  ...
  // When used as a non-dialog, just return the form content
  if (className) {
